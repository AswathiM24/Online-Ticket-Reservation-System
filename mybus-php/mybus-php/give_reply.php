...
if(isset($_POST['add_reply']))
{
  ...
  $query=mysqli_query($conn,"UPDATE complaint_tb SET reply='$reply' WHERE complaint_id='$complaint_id'");
              ...
              <div class="col-lg-6">
                <form method="POST">
                   <div class="form-group">
                    ...
                    <input class="form-control" name="reply" onkeyup="clearmsg('sp1')" id="bus_name" type="text">
                  </div>
