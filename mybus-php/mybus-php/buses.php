...
$data=mysqli_query($conn,"SELECT * FROM bus_tb JOIN login_tb ON bus_tb.login_id=login_tb.login_id ORDER BY bus_name");
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  while($row = mysqli_fetch_assoc($data)) { $count++; ?>
                    <tr>
                      ...
                      <td><?php echo $row['bus_starting_point']; ?></td>
                      <td><?php echo $row['bus_end_point']; ?></td>
                      <td><?php echo $row['bus_description']; ?></td>
                      <td><?php echo $row['bus_total_seats']; ?></td>
